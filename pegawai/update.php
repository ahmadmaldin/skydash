...
if ($foto != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
        ...
        $query  = "UPDATE pegawai SET nama = '$nama', jabatan = '$jabatan', telp = '$telp', email = '$email', foto = '$nama_foto_baru'";
        $query .= "WHERE nis = '$nis'";
    ...
    // jalankan query UPDATE berdasarkan NIS yang pegawainya kita edit
    $query  = "UPDATE pegawai SET nama = '$nama', jabatan = '$jabatan', telp = '$telp', email = '$email'";
    $query .= "WHERE nis = '$nis'";
    $result = mysqli_query($db, $query);
    // periska query apakah ada error
    if (!$result) {
